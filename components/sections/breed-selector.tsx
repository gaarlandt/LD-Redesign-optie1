...
export function BreedSelector() {
  return (
    <SectionWrapper className="bg-white" id="keuzehulp">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-[#141414]/70 text-[16px] leading-relaxed mb-4">
            Niet elk ras past bij elke eigenaar. Onze gratis keuzehulp stelt je 8 korte vragen over je levensstijl, woonruimte en ervaring — en geeft je een persoonlijk rasadvies.
          </p>
